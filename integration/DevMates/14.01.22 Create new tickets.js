...
describe('Ticket', function () {
    it('Create New Story ticket', function () {
        cy.viewport(1500, 1000)
        cy.visit('https://devmates-frontend-rlj79.ondigitalocean.app/dashboard')
        const button = cy.get('button[class="styles_button_create_ticket__1MvrV btn btn-primary"]')
        button.click()
...
describe('Ticket', function () {
    it('Create new bug report', function () {
        cy.viewport(1500, 1000)
        cy.visit('https://devmates-frontend-rlj79.ondigitalocean.app/dashboard')
